    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2.5 px-4 py-4 border-b border-border flex-shrink-0">
          ...
          <div>
            <p className="text-sm font-extrabold text-primary leading-tight">ChatApp</p>
        ...
        <div className="px-3 pb-3 flex-shrink-0">
          <button
            onClick={onNewChat}
            className="w-full flex items-center justify-center gap-2 py-2 bg-blue hover:bg-blue-hover
          ...
          {filtered.map(c => (
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg mb-0.5 text-left
                ...
                ${activeId === c.id
                  ? "bg-blue/20 border-l-2 border-blue"
          ...
          {[
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-muted
                hover:text-primary hover:bg-card transition-colors text-sm"
            >
